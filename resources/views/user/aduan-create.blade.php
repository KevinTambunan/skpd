                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_perangkat_daerah') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="email_pemohon" name="email_pemohon" value="{{ old('email_pemohon') }}">
                                        @error('email_pemohon')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="alamat_lokasi" name="alamat_lokasi" value="{{ old('alamat_lokasi') }}">
                                        @error('alamat_lokasi')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
